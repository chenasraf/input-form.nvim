...
--- Configure the plugin. Optional — defaults are used if not called.
---
--- Also registers the bundled helptags so `:h input-form` works immediately.
...
function M.setup(opts)
  ...
  -- Register the generated helptags automatically. Best-effort; never fails setup.
